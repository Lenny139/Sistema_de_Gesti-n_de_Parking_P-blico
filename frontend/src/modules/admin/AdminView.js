...
export default class AdminView extends BaseView {
    ...
    renderDashboard(data) {
        const tickets = this.container.querySelector('#stat-tickets');
        const ingresos = this.container.querySelector('#stat-ingresos');
        const ocupacion = this.container.querySelector('#stat-ocupacion');
        const estadia = this.container.querySelector('#stat-estadia');
        const bars = this.container.querySelector('#dashboard-bars');
        if (tickets) {
    ...
    renderReporte(data) {
        const body = this.container.querySelector('#reporte-body');
        const total = this.container.querySelector('#reporte-total');
        if (body) {
    ...
    renderTarifas(data) {
        ...
        const detalle = this.container.querySelector('#tarifa-activa-detalle');
        const tarifaId = this.container.querySelector('#tarifa-id');
        const precioHora = this.container.querySelector('#tarifa-precioHora');
        const diaCompleto = this.container.querySelector('#tarifa-diaCompleto');
        const nocturna = this.container.querySelector('#tarifa-nocturna');
        const perdido = this.container.querySelector('#tarifa-perdido');
        if (!activa) {
            if (detalle) {
    ...
    renderHistorial(data, pagina) {
        ...
        const body = this.container.querySelector('#historial-body');
        const total = this.container.querySelector('#historial-total');
        const page = this.container.querySelector('#hist-page');
        if (body) {
            body.innerHTML = rows
                .map((row) => `
          <tr>
    ...
    renderHeader() {
        ...
        const headerHost = this.container.querySelector('#admin-header');
        if (!headerHost) {
            return;
        }
