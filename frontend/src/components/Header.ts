...
export default class Header {
  ...
  private readonly props: HeaderProps
  ...
  render(container: HTMLElement): void {
    ...
    const lang = container.querySelector('#header-lang') as HTMLSelectElement | null
    const theme = container.querySelector('#header-theme') as HTMLButtonElement | null
    const logout = container.querySelector('#header-logout') as HTMLButtonElement | null
